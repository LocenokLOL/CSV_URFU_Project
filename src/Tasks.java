...
public class Tasks {
    ...
    public void Task2(){
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT MAX(Economy) AS Economy FROM Country,RegionRank WHERE " +
                    "(RegionRank.Region = '12' or RegionRank.Region = '38') and RegionRank.Rank = Country.HappinessRank");
            while (rs.next()){
    ...
    public void Task4(){
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:UrfuProject.db");
            stmt = c.createStatement();
            stmt.executeUpdate("ALTER TABLE Country DROP COLUMN RegionID");
    ...
    public void Task5(){
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:UrfuProject.db");
            stmt = c.createStatement();
            stmt.executeUpdate("UPDATE RegionRank SET Region = (SELECT RegionID FROM Region WHERE Region.Region = RegionRank.Region) WHERE EXISTS (SELECT RegionID" +
                    " FROM Region" +
                    "  WHERE Region.Region = RegionRank.Region);");
